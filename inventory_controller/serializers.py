...
from .models import Color, Inventory, InventoryGroup, Photo, Shop, Invoice, InvoiceItem, Size
...
class InventoryGroupSerializer(serializers.ModelSerializer):
    ...
    belongs_to_id = serializers.CharField(
...
class InventorySerializer(serializers.ModelSerializer):
    ...
    group_id = serializers.CharField(
        write_only=True,  required=False, allow_null=True)
    photo = PhotoSerializer(many=True, required=False, read_only=True)
    compare_price = serializers.DecimalField(required=False, max_digits=10,
                                             decimal_places=2)
